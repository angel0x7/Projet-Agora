...
if (isset($_GET['id'])) {
    ...
    // Récupérer les images du produit à modifier
    ...
    while ($imageRow = $imageResult->fetch_assoc()) {
        $productImages[] = $imageRow['image_path'];
    }

    // Récupérer la vidéo du produit à modifier
    $videoStmt = $conn->prepare("SELECT * FROM product_videos WHERE product_id = ?");
    ...
    if ($videoResult->num_rows > 0) {
        ...
        $productVideo = $videoRow['video_path'];
    }
            ...
            <div class="container mt-5">
                ...
                <form action="update_product.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($productVideo): ?>
                            <div><?php echo basename($productVideo); ?></div>
                            <input type="hidden" name="existing_video" value="<?php echo htmlspecialchars($productVideo); ?>">
                        <?php endif; ?>
                    </div>
